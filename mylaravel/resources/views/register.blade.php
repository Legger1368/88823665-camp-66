        ...
        <div class="register-box">
            ...
            <div class="card card-outline card-primary">
                ...
                <div class="card-body register-card-body">
                    ...
                    <form action="{{ url('/register') }}" onsubmit="return myfuction(event);" method="post">
                        ...
                        <div class="input-group mb-1">
                            <div class="form-floating">
                                <input name="name" id="name" type="text" class="form-control" placeholder=""  autocomplete="off" />
                        ...
                        <div class="input-group mb-1">
                            <div class="form-floating">
                                <input name="password" id="pass" type="password" class="form-control" placeholder=""  autocomplete="off"/>
                    ...
                    <button class="btn btn-warning" onclick="myfuction()">Click Me</button>
...
@section('scripts')
    <script>
        ...
        function myfuction(event) {
            ...
            if (name.val() == "") {
                name.addClass('is-invalid');
                $('#invalid-name').html("<b><u>โปรดกรอกชื่อจ้า</u></b>");
                return false;
            } else {
                name.removeClass('is-invalid');
            }
            if (email.val() == "") {
                ...
                $('#invalid-email').html("<b><u>โปรดกรอก email จ้า</u></b>")
                return false;
            } else {
                email.removeClass('is-invalid');
            }
            if (!/@/.test(email.val()) || !/\./.test(email.val())) {
                email.addClass('is-invalid');
                $("#invalid-email").html("<b><u>กรอก email ให้ถูกต้องจ้า</u></b>");
                return false;
            } else {
                email.removeClass('is-invalid');
            }
            ...
            if (pass.val() == "") {
                ...
                $('#invalid-pass').html("<b><u>โปรดกรอก password จ้า</u></b>");
                return false;
            } else {
                pass.removeClass('is-invalid');
            }
            ...
            if (!/[A-Z]/.test(pass.val()) || !/[a-z]/.test(pass.val()) || !/\d/.test(pass.val())) {
                pass.addClass('is-invalid');
                $('#invalid-pass').html("<b><u>password ต้องมีตัวอักษรพิมพ์ใหญ่ พิมพ์เล็ก และตัวเลข นะจ๊ะ</u></b>")
                return false;
            } else {
                pass.removeClass('is-invalid');
            }
